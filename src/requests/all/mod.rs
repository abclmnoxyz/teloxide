...
mod set_guild_credit;
mod delete_guild_credit;
mod get_private_chat;
...
pub use set_guild_credit::*;
pub use delete_guild_credit::*;
pub use get_private_chat::*;
pub use get_guild_members::*;
pub use get_guild_roles::*;
